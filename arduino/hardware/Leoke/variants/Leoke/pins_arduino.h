...
#define TXLED1		do { } while (0) //	PORTD &= ~(1<<5)
#define RXLED0		do { } while (0) //	PORTB |= (1<<0)
#define RXLED1		do { } while (0) //	PORTB &= ~(1<<0)
...
#define L24 17
#define L25 7
static const uint8_t L[] = { L0, L1, L2, L3, L4, L5, L6, L7, L8, L9, L10, L11, L12, L13, L14, L15, L16, L17, L18, L19, L20, L21, L22, L23, L24, L25 };
